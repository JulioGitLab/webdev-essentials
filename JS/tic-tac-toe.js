...
const checkWin = function () {
  ...
  if (
    tiles[0].label !== "" &&
    tiles[0].label === tiles[1].label &&
    tiles[0].label === tiles[2].label
  ) {
    tiles[0].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 1;
  } else if (
    tiles[3].label !== "" &&
    tiles[3].label === tiles[4].label &&
    tiles[3].label === tiles[5].label
  ) {
    tiles[3].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 2;
  } else if (
    tiles[6].label !== "" &&
    tiles[6].label === tiles[7].label &&
    tiles[6].label === tiles[8].label
  ) {
    tiles[6].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 3;
  } else if (
    tiles[0].label !== "" &&
    tiles[0].label === tiles[3].label &&
    tiles[0].label === tiles[6].label
  ) {
    tiles[0].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 4;
  } else if (
    tiles[1].label !== "" &&
    tiles[1].label === tiles[4].label &&
    tiles[1].label === tiles[7].label
  ) {
    tiles[1].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 5;
  } else if (
    tiles[2].label !== "" &&
    tiles[2].label === tiles[5].label &&
    tiles[2].label === tiles[8].label
  ) {
    tiles[2].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 6;
  } else if (
    tiles[0].label !== "" &&
    tiles[0].label === tiles[4].label &&
    tiles[0].label === tiles[8].label
  ) {
    tiles[0].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 7;
  } else if (
    tiles[6].label !== "" &&
    tiles[6].label === tiles[4].label &&
    tiles[6].label === tiles[2].label
  ) {
    tiles[6].label === "🐶" ? (winner = 0) : (winner = 1);
    winLine = 8;
  } else if (tie === 9) {
...
const drawWin = function () {
  ...
  switch (winLine) {
    ...
    case 4:
      ...
      break;
    case 5:
      line(cW * 0.09, cH * 0.7, cW * 0.91, cH * 0.7);
      break;
    case 6:
